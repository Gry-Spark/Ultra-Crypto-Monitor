...
tickers = ['BTCUSDT','NBSUSDT','ATOMUSDT']


col1 = st.columns(1)


length = st.slider("Tps at less", value=1,max_value=100)
...
st.dataframe(dff.style.applymap(color_negative_values , subset=['price_chg_Live','TPS_1h','⚡️W48_Space5m⚡️','Score48_1h','TPS_chg_1H','TPS_1H_LIVE','TPS_5m','🎁Special TPS🎁','ATS_1h_list','ATS_chg_1H_list','SortData_final1h']).applymap(lambda x: 'font-size:23.2px; background-color: #131c25' ))
